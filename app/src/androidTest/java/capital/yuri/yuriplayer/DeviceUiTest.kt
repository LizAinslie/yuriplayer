...
class DeviceUiTest {
    ...
    fun tabsAndCatalogOpen() {
        rule.waitForTag(TestTags.TAB_MY_STUFF)
        ...
        rule.onNodeWithTag(TestTags.MYSTUFF_CATALOG).performClick()
        ...
        rule.onNodeWithTag(TestTags.MYSTUFF_PLAYLISTS).assertIsDisplayed()
    }
